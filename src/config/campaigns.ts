...
export const boysCampaign: CampaignConfig = {
  id: "boys",
  title: "ボーイズリーグキャンペーン",
  description: "ボーイズリーグ応援キャンペーンを開催します",
  ...
  products: [
    ...
    // product13 is commented out/sold out in original
    // { id: "product13", name: "熱中対策水ソフトパウチ 300g(日向夏味)", unit: "case" },
